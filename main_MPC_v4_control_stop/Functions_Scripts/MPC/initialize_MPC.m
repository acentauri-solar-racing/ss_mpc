...
function [par, f, obj, X, U, P, S1, S2] = initialize_MPC(par)
    ...
    variables = [var.alpha; 
                var.G_1; var.G_2; var.G_3; 
                var.fW_1; var.fW_2; var.fW_3; 
                var.sW_1; var.sW_2; var.sW_3;  
                var.temp_1; var.temp_2; var.temp_3];
    ...
    % 3 states, N alpha prediction, 12 polynomial parameters, 1 SoC DP at
    % horizon N, 1 next control stop position,N+1 positions until horizon N, 
    P = SX.sym('P', par.n_states + par.N + 12 + 1 + 1 + par.N+1);               
