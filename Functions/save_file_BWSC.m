...
function save_file = save_file_BWSC(OptRes, par, weather)
    ...
    writematrix([horzcat(OptRes.xdist, OptRes.xx)],'G:\Shared drives\AlphaCentauri\SolarCar_22 23\6. Strategy & Simulation\ss_online_data\NLP_optimal\NLP_'+par.filename+'\MPC_'+par.filename+'_states.csv')
    writematrix([horzcat(OptRes.xdist(2:end), OptRes.u_cl)],'G:\Shared drives\AlphaCentauri\SolarCar_22 23\6. Strategy & Simulation\ss_online_data\MPC_optimal\NLP_'+par.filename+'\MPC_'+par.filename+'_inputs.csv')
end
