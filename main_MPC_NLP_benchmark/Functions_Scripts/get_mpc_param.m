...
function par = get_mpc_param(par, s_0, t_0, s_step, N, s_tot, slack_weight)
        ...
        par.E_bat_target_DP = interp1(linspace(0,par.s_final/par.s_step_DP,par.s_final/par.s_step_DP+1), par.E_bat_target_DP_raw, linspace(0,par.s_final/par.s_step_DP,(par.s_final/par.s_step_DP)*round(par.s_step_DP/par.s_step)+1));
        
        par.v_DP_raw = load('OfflineData\Full_Race_20230607_9h_30min.mat').OptRes.states.V; % [m/s]
        par.v_DP = interp1(linspace(0,par.s_final/par.s_step_DP,par.s_final/par.s_step_DP+1), par.v_DP_raw, linspace(0,par.s_final/par.s_step_DP,(par.s_final/par.s_step_DP)*round(par.s_step_DP/par.s_step)+1));
        
        par.P_mot_el_DP_raw = load('OfflineData\Full_Race_20230607_9h_30min.mat').OptRes.inputs.P_mot_el; % [m/s]
        par.P_mot_el_DP = interp1(linspace(1,par.s_final/par.s_step_DP,par.s_final/par.s_step_DP), par.P_mot_el_DP_raw , linspace(1,par.s_final/par.s_step_DP,par.s_final/par.s_step_DP*round(par.s_step_DP/par.s_step)));
