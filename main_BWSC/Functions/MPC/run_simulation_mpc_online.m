...
function [par, OptRes] = run_simulation_mpc_online(par, weather, args, f, solver, s_0, t_0)
    ...
    [p_G, p_fW, p_rho, p_temp] = get_polynomial_weather_fit(weather, par, par.N, t_0, par.N_t);
    [p_G_r, p_fW_r, p_rho_r, p_temp_r] = get_polynomial_weather_fit(weather, par, 1, t_0, 0);
    ...
    while par.iter_mpc < par.iter_mpc_max
        ...
        %%
        [p_G, p_fW, p_rho, p_temp] = get_polynomial_weather_fit(weather, par, par.N, x0(3), par.N_t);
        [p_G_r, p_fW_r, p_rho_r, p_temp_r] = get_polynomial_weather_fit(weather, par, 1, x0(3), 0);
