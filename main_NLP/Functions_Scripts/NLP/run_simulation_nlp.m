...
function [par, OptResNLP] = run_simulation_nlp(par, weather, args, solver, s_0, t_0, v_0, SoC_0, velocity_target, SoC_target)
%% NLP optimization over entire horizon
    ...
    % args.ubx(E_bat_idx(end),1) = SoC_target +par.E_bat_max*0.00001;  
    ...
    OptResNLP.xSoC_N(1) = par.E_bat_target_DP(par.iter_initial+par.N);
